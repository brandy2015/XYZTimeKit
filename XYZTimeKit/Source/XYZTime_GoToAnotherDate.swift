...
public extension Date{
    ...
    //数一个月有多少天
    var monthDays              :Int         { return self.CurrentDateInRegion.monthDays  }
    //数今天到这月末有多少天
    var CountDaysEndToMonth    :Int{  return self.CurrentDateInRegion.monthDays - self.day + 1 }
}

public extension Date{
    var TestDate1:Date{  return PreMonStart}
    var TestDate2:Date{  return PreMonEnd  }
    var TestDate3:Date{  return PreDayEnd  }
}
